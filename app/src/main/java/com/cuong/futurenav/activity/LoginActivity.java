...
public class LoginActivity extends BaseAppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        mIsAppLaunch = (i.getAction() == Intent.ACTION_MAIN);
...
//                .build();
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            ...
            //if launching app, then go to main screen
            //else logging out, show sign out button

            if (mIsAppLaunch){

                logd("token: " + acct.getIdToken());
                logd("photo: " + acct.getPhotoUrl().toString());
                MainIntentService.signIn(mReceiver, this, acct.getDisplayName(), acct.getEmail(), acct.getPhotoUrl().toString(), "GOOGLE", acct.getIdToken());
    ...
    public void onReceiveResult(int resultCode, Bundle resultData) {
        switch (resultCode) {
            ...
            case MainIntentService.RESULT_CODE_COMPLETED:
                ...
                i.putExtra(MainIntentService.EXTRA_RESULT_STUDENT_PROFILE, studentProfile);
